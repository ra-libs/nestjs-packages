## [1.1.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.1.0...commons-v1.1.1) (2023-11-26)
...
* **commons:** add logs for debug in request id ([#27](https://github.com/ra-libs/nestjs-packages/issues/27)) ([ac5ed76](https://github.com/ra-libs/nestjs-packages/commit/ac5ed76f0df6fd4744e2e0a18d886c9a4c654255))
* **commons:** change build target to es2017 ([a7cc260](https://github.com/ra-libs/nestjs-packages/commit/a7cc2607919cacfd395d56da56b7237d4bd72652))
* **commons:** export account-owner types ([#39](https://github.com/ra-libs/nestjs-packages/issues/39)) ([97858ce](https://github.com/ra-libs/nestjs-packages/commit/97858ce3717bf3846f550956800ce69ef46c1c47))
* **commons:** export account-owner types ([#40](https://github.com/ra-libs/nestjs-packages/issues/40)) ([d9d1102](https://github.com/ra-libs/nestjs-packages/commit/d9d1102668d7c397cec5446c73a6c7605a2115fe)), closes [#41](https://github.com/ra-libs/nestjs-packages/issues/41)
* **commons:** export account-owner-decorator ([#37](https://github.com/ra-libs/nestjs-packages/issues/37)) ([cbd1cde](https://github.com/ra-libs/nestjs-packages/commit/cbd1cded4694bf9f2ac45b35f547d830522701bb))
...
* **commons:** uuidv4 method ([4c5a02a](https://github.com/ra-libs/nestjs-packages/commit/4c5a02a42c6175b8fc3d568fa818de51355ebe19))
...
* add fill user data middleware ([d969e8a](https://github.com/ra-libs/nestjs-packages/commit/d969e8aa5a7db267b5fa0c6d74b33a8796f36844))
...
* add RequestMiddleware ([#56](https://github.com/ra-libs/nestjs-packages/issues/56)) ([73c5645](https://github.com/ra-libs/nestjs-packages/commit/73c56459f7d8ec6c11fa66859c65b94fb5160877))
...
* add x-customer-id header ([3132ae6](https://github.com/ra-libs/nestjs-packages/commit/3132ae63c4b8881b53e7bc86c32e32c17cf8c72d))
...
* **commons:** adding account owner decorator ([#36](https://github.com/ra-libs/nestjs-packages/issues/36)) ([dbf742b](https://github.com/ra-libs/nestjs-packages/commit/dbf742bc515a17fce0948a961e821258f06d1b09))
...
## [2.5.2](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.5.1...commons-v2.5.2) (2023-11-24)

### Bug Fixes

- **logger:** app name local ([9127db8](https://github.com/ra-libs/nestjs-packages/commit/9127db8500ac83110cfb93dbbd6077edffc42d71))

## [2.5.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.5.0...commons-v2.5.1) (2023-11-21)

### Bug Fixes

- **logger:** use inject logger in request middleware to get correlation id ([1743d8a](https://github.com/ra-libs/nestjs-packages/commit/1743d8ad2fb6de105fa9b6fe1c2393897d1eb31f))

# [2.5.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.4.1...commons-v2.5.0) (2023-11-21)

### Features

- **sqs:** add RawMessage and Message type ([27d1967](https://github.com/ra-libs/nestjs-packages/commit/27d1967ea41ee486a8ef4d1a9e02791ac5a7a878))

## [2.4.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.4.0...commons-v2.4.1) (2023-11-21)
...
# [2.4.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.3.2...commons-v2.4.0) (2023-11-21)

### Features

- **logger:** add child method to winston logger ([a3a6331](https://github.com/ra-libs/nestjs-packages/commit/a3a6331771fdf2eabd4353434f61bb9ac4256806))

## [2.3.2](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.3.1...commons-v2.3.2) (2023-11-20)

### Bug Fixes

- add sourceClass on WinstonLogger constructor ([4331bd2](https://github.com/ra-libs/nestjs-packages/commit/4331bd2ab079e94e3b732a0c40dfed3cbe6718ec))

## [2.3.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.3.0...commons-v2.3.1) (2023-11-20)

### Bug Fixes

- **logger:** add sourceClass to winston logger constructor ([e502d1c](https://github.com/ra-libs/nestjs-packages/commit/e502d1c0f6cad80d2021922412ea652d15e7340d))

# [2.3.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.2.0...commons-v2.3.0) (2023-11-20)

### Features

- move RequestLogger to logger lib and add log level by status code ([eb95b6f](https://github.com/ra-libs/nestjs-packages/commit/eb95b6f2f24bf7e28e8a878f6553446f25016c70))

# [2.2.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.1.3...commons-v2.2.0) (2023-11-18)

### Features

- **unleash:** add unleash lib ([5fa52d5](https://github.com/ra-libs/nestjs-packages/commit/5fa52d5dc68c6270b6e6978c419e742cb5d11bc3))

## [2.1.3](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.1.2...commons-v2.1.3) (2023-11-16)

### Bug Fixes

- **logger:** morgan format ([1a1c01f](https://github.com/ra-libs/nestjs-packages/commit/1a1c01fbb59c562f370107d2dca2d0884cd2ad60))

## [2.1.2](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.1.1...commons-v2.1.2) (2023-11-15)

### Bug Fixes

- add logger doc ([0b3f7ab](https://github.com/ra-libs/nestjs-packages/commit/0b3f7ab30978a929c1e044f3277f73fa4f6ae3c6))

## [2.1.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.1.0...commons-v2.1.1) (2023-11-15)

### Bug Fixes

- **logger:** add correlationId to log meta event without props ([9193f7f](https://github.com/ra-libs/nestjs-packages/commit/9193f7f8bd306079d2264b741b915174405dc016))

# [2.1.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v2.0.0...commons-v2.1.0) (2023-11-15)

### Features

- add x-customer-id header ([3132ae6](https://github.com/ra-libs/nestjs-packages/commit/3132ae63c4b8881b53e7bc86c32e32c17cf8c72d))

# [2.0.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.10.1...commons-v2.0.0) (2023-11-15)
...
## [1.10.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.10.0...commons-v1.10.1) (2023-10-30)

### Bug Fixes

- **sqs:** consumer error throw catch ([#70](https://github.com/ra-libs/nestjs-packages/issues/70)) ([90ad27b](https://github.com/ra-libs/nestjs-packages/commit/90ad27b0a5bbd13c81c17703cbed7ac4a032254b))

# [1.10.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.9.0...commons-v1.10.0) (2023-10-12)

### Features

- add fill user data middleware ([d969e8a](https://github.com/ra-libs/nestjs-packages/commit/d969e8aa5a7db267b5fa0c6d74b33a8796f36844))

# [1.9.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.8.0...commons-v1.9.0) (2023-09-12)

### Features

- **sqs:** add consumers ([#65](https://github.com/ra-libs/nestjs-packages/issues/65)) ([ce5a2dd](https://github.com/ra-libs/nestjs-packages/commit/ce5a2dd13d7be5dd3cedee06f856cd90193dba56))

# [1.8.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.7.2...commons-v1.8.0) (2023-09-04)

### Features

- **athena:** add athena package ([#62](https://github.com/ra-libs/nestjs-packages/issues/62)) ([301637d](https://github.com/ra-libs/nestjs-packages/commit/301637ddf3705b06a00899f16b81440496535d0a))

## [1.7.2](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.7.1...commons-v1.7.2) (2023-08-31)

### Bug Fixes

- **logger:** remove console.log ([72c42b6](https://github.com/ra-libs/nestjs-packages/commit/72c42b65321aaa93591a8396d8d992b7f04774a0))

## [1.7.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.7.0...commons-v1.7.1) (2023-08-31)

### Bug Fixes

- **logger:** log nestLike on non production NODE_ENV ([bd867e1](https://github.com/ra-libs/nestjs-packages/commit/bd867e1c06a0f06ea5da0404e9a4cabadff3135d))

# [1.7.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.6.0...commons-v1.7.0) (2023-08-25)

### Features

- add sqs initial module with producer only ([#58](https://github.com/ra-libs/nestjs-packages/issues/58)) ([ebf5ed1](https://github.com/ra-libs/nestjs-packages/commit/ebf5ed1aaa47d5941119947d0a5e4262d180ca62))

# [1.6.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.5.0...commons-v1.6.0) (2023-08-22)

### Features

- add s3 initial lib ([#57](https://github.com/ra-libs/nestjs-packages/issues/57)) ([74ccde3](https://github.com/ra-libs/nestjs-packages/commit/74ccde39f642c662dc7ea462ae9a0b80a36e36e5))

# [1.5.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.4.6...commons-v1.5.0) (2023-08-21)
...
## [1.4.6](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.4.5...commons-v1.4.6) (2023-08-16)

### Bug Fixes

- update deps ([#53](https://github.com/ra-libs/nestjs-packages/issues/53)) ([7a94ea7](https://github.com/ra-libs/nestjs-packages/commit/7a94ea7e68ad32400448f4df0a4c163d879e1cd7))

## [1.4.5](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.4.4...commons-v1.4.5) (2023-07-22)

### Bug Fixes

- **commons:** remove v4 uuid validation ([#38](https://github.com/ra-libs/nestjs-packages/issues/38)) ([9c90484](https://github.com/ra-libs/nestjs-packages/commit/9c90484b66db6b10b3b2f0ac9b03bcfb95589fdd))

## [1.4.4](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.4.3...commons-v1.4.4) (2023-07-20)

### Bug Fixes

- semantic-release ([#43](https://github.com/ra-libs/nestjs-packages/issues/43)) ([f033420](https://github.com/ra-libs/nestjs-packages/commit/f0334207498ae97c1f70dea2cdb51f8c61ef9db2))

## [1.4.3](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.4.2...commons-v1.4.3) (2023-07-17)

### Bug Fixes

- **commons:** export account-owner types ([#40](https://github.com/ra-libs/nestjs-packages/issues/40)) ([d9d1102](https://github.com/ra-libs/nestjs-packages/commit/d9d1102668d7c397cec5446c73a6c7605a2115fe)), closes [#41](https://github.com/ra-libs/nestjs-packages/issues/41)

## [1.4.2](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.4.1...commons-v1.4.2) (2023-07-14)

### Bug Fixes

- **commons:** export account-owner types ([#39](https://github.com/ra-libs/nestjs-packages/issues/39)) ([97858ce](https://github.com/ra-libs/nestjs-packages/commit/97858ce3717bf3846f550956800ce69ef46c1c47))

## [1.4.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.4.0...commons-v1.4.1) (2023-07-14)

### Bug Fixes

- **commons:** export account-owner-decorator ([#37](https://github.com/ra-libs/nestjs-packages/issues/37)) ([cbd1cde](https://github.com/ra-libs/nestjs-packages/commit/cbd1cded4694bf9f2ac45b35f547d830522701bb))

# [1.4.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.3.0...commons-v1.4.0) (2023-07-14)

### Features

- **commons:** adding account owner decorator ([#36](https://github.com/ra-libs/nestjs-packages/issues/36)) ([dbf742b](https://github.com/ra-libs/nestjs-packages/commit/dbf742bc515a17fce0948a961e821258f06d1b09))

# [1.3.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.2.0...commons-v1.3.0) (2023-07-11)

### Features

- **secrets-manager:** add initial lib ([#35](https://github.com/ra-libs/nestjs-packages/issues/35)) ([0b079db](https://github.com/ra-libs/nestjs-packages/commit/0b079db636a14d69fa98f921294abedf9b96d5a3))

# [1.2.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.1.1...commons-v1.2.0) (2023-07-11)

### Features

- **ssm:** add initial lib ([#32](https://github.com/ra-libs/nestjs-packages/issues/32)) ([73f745b](https://github.com/ra-libs/nestjs-packages/commit/73f745beb3e189517a503d523910123f288115b8))

## [1.1.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.1.0...commons-v1.1.1) (2023-07-09)

### Bug Fixes

- update deps ([#30](https://github.com/ra-libs/nestjs-packages/issues/30)) ([6f7e07d](https://github.com/ra-libs/nestjs-packages/commit/6f7e07da21f7e2958b810da6b8030011d16e5144))

# [1.1.0](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.0.5...commons-v1.1.0) (2023-07-09)

### Features

- **logger:** add nestjs-like format for local development ([#29](https://github.com/ra-libs/nestjs-packages/issues/29)) ([2f68240](https://github.com/ra-libs/nestjs-packages/commit/2f6824008fd30c962aac3803fe7b09ef36b37527))

## [1.0.5](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.0.4...commons-v1.0.5) (2023-07-06)

### Bug Fixes

- **commons:** generate new uuid if the headers one is invalid v4 format ([#28](https://github.com/ra-libs/nestjs-packages/issues/28)) ([a4d0bec](https://github.com/ra-libs/nestjs-packages/commit/a4d0becf5f5b64165c1516fafaa35a0718936b86))

## [1.0.4](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.0.3...commons-v1.0.4) (2023-07-06)

### Bug Fixes

- **commons:** add logs for debug in request id ([#27](https://github.com/ra-libs/nestjs-packages/issues/27)) ([ac5ed76](https://github.com/ra-libs/nestjs-packages/commit/ac5ed76f0df6fd4744e2e0a18d886c9a4c654255))

## [1.0.3](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.0.2...commons-v1.0.3) (2023-07-06)

### Bug Fixes

- **commons:** use crypto.randomUUID for uuid v4 ([4048f9a](https://github.com/ra-libs/nestjs-packages/commit/4048f9aec257a623fbb7f2ad0b1114768282a337))

## [1.0.2](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.0.1...commons-v1.0.2) (2023-07-06)

### Bug Fixes

- **commons:** change build target to es2017 ([a7cc260](https://github.com/ra-libs/nestjs-packages/commit/a7cc2607919cacfd395d56da56b7237d4bd72652))

## [1.0.1](https://github.com/ra-libs/nestjs-packages/compare/commons-v1.0.0...commons-v1.0.1) (2023-07-06)
